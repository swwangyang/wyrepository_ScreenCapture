...
//                    parser, android.view.PointerIcon);
            TypedArray a = resources.obtainAttributes(
                    parser, R.styleable.PointerIcon);
            
            bitmapRes = a.getResourceId(R.styleable.PointerIcon_bitmap, 0);
            hotSpotX = a.getFloat(R.styleable.PointerIcon_hotSpotX, 0);
            hotSpotY = a.getFloat(R.styleable.PointerIcon_hotSpotY, 0);
            a.recycle();
        } catch (Exception ex) {
